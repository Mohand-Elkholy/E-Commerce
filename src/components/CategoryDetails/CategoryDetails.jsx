...
return (
    ...
    <Helmet>
        ...
        {filteredData.length == 0 ? <div className='flex items-center justify-center flex-col'>
            ...
            <h2 className='  mt-4 dark:text-slate-100 text-sm md:text-lg lg:text-2xl'>There is no products in {name} Category</h2>
            <Link to={"/Categories"} className='btn p-2 mt-5 text-sm md:text-lg '>Go Back To Categories</Link>
        </div> : <>
