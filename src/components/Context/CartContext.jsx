...
export default function CartContextProvider({children}) {
  ...
  async function onlinePayment(shippingAddress) {
    await axios.post(`https://ecommerce.routemisr.com/api/v1/orders/checkout-session/${cartId}?url=https://e-commerce-hx50debma-mohand-elkholys-projects.vercel.app/`,{shippingAddress},{headers})
    .then((res)=>{
